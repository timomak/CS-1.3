...
class BinaryTreeNode(object):
    ...
    def height(self):
        ...
        downward path from this node to a descendant leaf node).
         Best and worst case running time: O(n) for number of nodes in tree"""
...
if __name__ == '__main__':
    ...
    # tree_3 = BinaryTreeNode(data="Data3")
    # tree_2 = BinaryTreeNode(data="Data2")
    # tree_2.left = tree_3
    # tree_1 = BinaryTreeNode(data="Data")
    # tree_1.left = tree_2
    # print(tree_1.height())
